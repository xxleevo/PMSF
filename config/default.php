...
$sessionLifetime = 604800;                                           // Session lifetime, in seconds - default is 7 days now to prevent logouts too often
...
// FRONTEND SETTINGS
//-----------------------------------------------------
$hideCoords = [true,true,true,true,true];
...
$noEnergyNumbers = true;                                             // true/false
